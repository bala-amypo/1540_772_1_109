...
public PurchaseIntentServiceImpl(PurchaseIntentRecordRepository repo) { this.repo 
= repo; } 
public PurchaseIntentRecord createIntent(PurchaseIntentRecord intent) { return 
repo.save(intent); } 
